...
import {LiquidAccountConduit} from "../../contracts/conduits/LiquidAccountConduit.sol";
import {IHydrexVotingEscrow} from "../../contracts/interfaces/IHydrexVotingEscrow.sol";

/**
 * @title DeployLiquidAccountConduit
 * @dev Deployment script for LiquidAccountConduit mirroring the VeTokenConduit deploy flow
 */
contract DeployLiquidAccountConduit is Script {
    function run() public {
        ...
        LiquidAccountConduit conduit = new LiquidAccountConduit(admin, voter, optionsToken, veToken);
        ...
        console2.log("LiquidAccountConduit deployed at:", address(conduit));
    ...
    function _saveDeployment(
        ...
        string memory entryJson = "LiquidAccountConduit";
        ...
        string memory entryData = vm.serializeString(entryJson, "name", "LiquidAccountConduit");

        string memory contractData = vm.serializeString(contractsJson, "LiquidAccountConduit", entryData);
