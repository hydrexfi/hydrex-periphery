...
/**
 * @title DeployBribeBatches
 * @dev Script to deploy BribeBatches contract
 */
contract DeployBribeBatches is Script {
    function run() public {
        ...
        console2.log("=== BribeBatches Deployment ===");
        ...
        // Deploy BribeBatches contract
        BribeBatches bribeBatches = new BribeBatches();

        vm.stopBroadcast();

        console2.log("\n=== Deployment Successful ===");
        console2.log("BribeBatches deployed at:", address(bribeBatches));
    ...
    function _saveDeployment(string memory networkName, address bribeBatchesAddress, address deployer) internal {
        ...
        string memory bribeBatchesJson = "BribeBatches";
        ...
        vm.serializeUint(bribeBatchesJson, "epochDuration", 604800);
        string memory bribeBatchesData = vm.serializeString(bribeBatchesJson, "name", "BribeBatches");

        string memory contractData = vm.serializeString(contractJson, "BribeBatches", bribeBatchesData);
